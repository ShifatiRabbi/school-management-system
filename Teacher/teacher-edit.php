...
<body>
    ...
    <div class="container mt-5">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    <?php if (!empty($teacher['image_path'])): ?>
                        <img src="../admin/<?=$teacher['image_path']?>" class="img-thumbnail mb-2" style="max-width: 200px;">
                    <?php else: ?>
        ...
        <form method="post" class="shadow p-3 my-5 form" action="req/teacher-change.php" id="change_password">
