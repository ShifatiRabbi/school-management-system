                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="position" required>
                            ...
                            <option value="Member Secretary" <?= isset($member) && $member['position'] == 'Member Secretary' ? 'selected' : '' ?>>Member Secretary</option>
                            <option value="Guardians Representative" <?= isset($member) && $member['position'] == 'Guardians Representative' ? 'selected' : '' ?>>Guardians' Representative</option>
                            <option value="Teachers Representative" <?= isset($member) && $member['position'] == 'Teachers Representative' ? 'selected' : '' ?>>Teachers' Representative</option>
                            <option value="Bidyut Sahi Member" <?= isset($member) && $member['position'] == 'Bidyut Sahi Member' ? 'selected' : '' ?>>Bidyut Shahi Member</option>
                            <option value="Donor Member" <?= isset($member) && $member['position'] == 'Donor Member' ? 'selected' : '' ?>>Donor Member</option>
                        </select>
                    </div>
