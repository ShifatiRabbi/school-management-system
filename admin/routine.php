                        ...
                        <div class="card-footer bg-white border-top-0">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    ...
                                    <form method="post" action="routine-delete.php" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this routine?')">
<?= csrf_field() ?>
<input type="hidden" name="id" value="<?=$routine['routine_id']?>">
