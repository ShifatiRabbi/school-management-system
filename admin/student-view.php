...
if (isset($_SESSION['admin_id']) && 
    ...
    if ($_SESSION['role'] == 'Admin') {
       ...
       $previous_results = getStudentPreviousResults($student_id, $conn);
 ?>
<!DOCTYPE html>
<html lang="en">
<head>
     ...
     <div class="container mt-5">
         <div class="card" style="width: 22rem;">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">Section: <?=$student['section_name']?></li>
            <li class="list-group-item">Roll Number: <?=$student['roll_number']?></li>
            <li class="list-group-item">Last Exam Result: <?=$student['last_exam_result'] ?? 'N/A'?></li>
            <br><br>
            <li class="list-group-item">Father's Name: <?=$student['father_name']?></li>
            <li class="list-group-item">Mother's Name: <?=$student['mother_name']?></li>
        ...
        <div class="card mt-5">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($previous_results as $result) { ?>
                        <tr>
                            <td><?=$result['year']?></td>
                            <td><?=$result['class']?></td>
